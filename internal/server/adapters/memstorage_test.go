...
func TestMemStorage_Add(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			update:       []entities.MetricUpdate{{Type: entities.TypeCounter, Name: "Counter1", Value: "1"}},
			wantGauges:   map[string]float64{},
		...
		},
		{
			...
			update: []entities.MetricUpdate{
				{Type: entities.TypeCounter, Name: "Counter1", Value: "1"},
				{Type: entities.TypeCounter, Name: "Counter2", Value: "47"},
				{Type: entities.TypeCounter, Name: "Counter1", Value: "12"},
				{Type: entities.TypeCounter, Name: "Counter2", Value: "31"},
			},
			wantGauges:   map[string]float64{},
		...
		},
		{
			...
			update:       []entities.MetricUpdate{{Type: entities.TypeGauge, Name: "Gauge1", Value: "1.0"}},
		...
		},
		{
			...
			update: []entities.MetricUpdate{
				{Type: entities.TypeGauge, Name: "Gauge1", Value: "1.0"},
				{Type: entities.TypeGauge, Name: "Gauge2", Value: "5.43"},
				{Type: entities.TypeGauge, Name: "Gauge1", Value: "-33.11"},
				{Type: entities.TypeGauge, Name: "Gauge3", Value: "0.67"},
			},
		...
		},
		{
			...
			update: []entities.MetricUpdate{
				{Type: entities.TypeGauge, Name: "Gauge1", Value: "1.0"},
				{Type: entities.TypeCounter, Name: "Counter1", Value: "5"},
				{Type: entities.TypeGauge, Name: "Gauge2", Value: "-33.11"},
				{Type: entities.TypeCounter, Name: "Counter2", Value: "22"},
			},
